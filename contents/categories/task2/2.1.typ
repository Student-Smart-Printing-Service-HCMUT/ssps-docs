...
- Tiếp theo sinh viên sẽ thiết lập những thông số in bao gồm: Number of copies, Option Layout (Potrait layout Landscape layout), OptionPages (All Pages, Odd pages only, Even pages Only), Optinal Pages side (One sides, Both sides), etc.\
- Tiếp theo sinh viên có thể tiếp tục thiết lập các Advance Option như là Page size, Scale, Pages per sheet, etc.\
- Nếu đã thiết lập xong Advance Option hoặc không thiết lập thì sinh viên sẽ tiếp tục chọn vào Button Cancle hoặc Continue. Nếu Cancle thì hệ thống sẽ đưa sinh viên quay về trang OrderPrinting. Nếu chọn vào Button Continue thì hệ thống đưa sinh viên đến trang List of uploads & configured document.\
- Tại trang  này,  sinh  viên  có thể tiếp tục Thêm tài liệu in, Chọn tài liệu  và  xóa, Thông tin  giá tiền đơn hàng, Button Continue để tiến hành quá trình thanh toán và sinh viên được di chuyển đến trang Confirm order.\
